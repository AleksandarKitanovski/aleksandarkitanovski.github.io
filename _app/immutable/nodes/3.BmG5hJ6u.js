import"../chunks/CWj6FrbW.js";import"../chunks/9MT4eJaW.js";import{n as t,o}from"../chunks/DTmp4FBA.js";var i=t(`<div class="mt-2 mb-16 lg:my-10 mx-4 md:mx-32 lg:mx-80"><article><h1 class="text-4xl lg:text-5xl text-orange-600 mb-2">Career Summary</h1> <p class="text-justify text-lg lg:text-xl">I have a bachelors degree in Computer Science from FINKI, and 2 years work experience as a
			...
			Croatia.</p></article> <article class="mt-10"><h1 class="text-4xl lg:text-5xl text-orange-600 mb-2">Hobbies</h1> <p class="text-justify text-lg lg:text-xl">I have several hobbies that keep life exciting and fulfilling. I'm an avid gamer, immersing
			...
			trying out new recipes and making food for myself and my loved ones.</p></article></div>`);function l(e){var a=i();o(e,a)}export{l as component};
